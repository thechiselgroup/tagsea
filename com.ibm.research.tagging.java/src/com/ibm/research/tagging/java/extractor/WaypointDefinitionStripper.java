 ...
 * 
 * @author Mike
 * @deprecated There is no need to strip waypoint definitions, multiline waypoints are no longer supported
 */
public class WaypointDefinitionStripper 
{
	 ...
	 */
	public static String stripRawWaypointDefinition(String rawTag)
	{
		if(rawTag == null)
			return null;
