...
public class TagPowerpointDialog extends StatusDialog {
	...
	private WaypointEditorComposite editorComposite;
	...
	private boolean fIsShowSelection;
	...
	protected Control createDialogArea(Composite parent) 
	{
		...
		editorComposite = new WaypointEditorComposite(parent, SWT.NONE);
	...
	{	
		...
		fSlidesGroup.setText("Select slides to tag");
		...
		fIndividualCheck.setText("Tag individual slides");
		...
		fRangeCheck.setText("Tag slide range");
		...
		fShowCheck.setText("Tag as slide show");
	...
	private void refreshStatus() 
	{
		...
		{
			fSlideStatus.setText("Slide show selected");
		...
		else
		{
			if(fRangeCheck.getSelection())
			{
				...
				fSlideStatus.setText("Slide range " + (low+1) + " to " + (high+1) + " selected");
				getButton(IDialogConstants.OK_ID).setEnabled(true);
			}
			else
			{
				fSlideStatus.setText(count + " slides selected");
				getButton(IDialogConstants.OK_ID).setEnabled(true);
			}
		}
	}
	...
	protected void configureShell(final Shell newShell) 
	{
		...
		newShell.setText("Tag powerpoint slides");
		newShell.setImage(PowerpointWaypointPlugin.getDefault().getImageRegistry().get(PowerpointWaypointPlugin.IMG_PPT));
	}
	...
	{	
		...
		fIsShowSelection = fShowCheck.getSelection();
	 ...
	 * @return the tagNames
	 */
	public int[] getSelectedSlideIndices() 
	{
