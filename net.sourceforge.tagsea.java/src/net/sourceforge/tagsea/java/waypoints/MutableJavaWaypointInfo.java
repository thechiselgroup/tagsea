...
import net.sourceforge.tagsea.java.waypoints.parser.JavaWaypointInfo;
 ...
 * @author Del Myers
 */
//@tag tagsea.syntax : if syntax changes, this has to be changed too.
public class MutableJavaWaypointInfo extends JavaWaypointInfo implements IParsedJavaWaypointInfo {
	 ...
	 * @param prototype
	 */
	public MutableJavaWaypointInfo(IParsedJavaWaypointInfo prototype, TagStyle preferredStyle) {
	...
	public MutableJavaWaypointInfo() {
	...
	//@tag tagsea.refactoring : here is where all the tough stuff happens!
...
//			adjust all the regions that come after the replacement.
	...
	public void setAttribute(String name, String value) throws IllegalArgumentException {
		if (IJavaWaypointAttributes.ATTR_RESOURCE.equals(name) 
				|| IJavaWaypointAttributes.ATTR_JAVA_ELEMENT.equals(name)
				|| IJavaWaypointAttributes.ATTR_CHAR_END.equals(name)
				|| IJavaWaypointAttributes.ATTR_CHAR_START.equals(name)
		) {
