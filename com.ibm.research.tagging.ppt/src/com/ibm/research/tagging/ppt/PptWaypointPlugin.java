 ...
 */
public class PptWaypointPlugin extends AbstractUIPlugin {

	// The plug-in ID
	public static final String PLUGIN_ID = "com.ibm.research.tagging.ppt";
		
	// The shared instance
	private static PptWaypointPlugin plugin;
	
	/**
	 * The constructor
	 */
	public PptWaypointPlugin() {
		plugin = this;
	}
	 ...
	 */
	public static PptWaypointPlugin getDefault() {
		return plugin;
	}
