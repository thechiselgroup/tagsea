...
public class MarkerCWaypointInfo extends CWaypointInfo {
	 ...
	 * 
	 */
	public MarkerCWaypointInfo(IMarker marker) {
		this.marker = marker;
	}
	...
	public Map<String, String> getAttributes() {
		...
		try {
			...
			attributes.put(ICWaypointAttributes.ATTR_CHAR_START, ""+start);
			attributes.put(ICWaypointAttributes.ATTR_CHAR_END, ""+(end));
			attributes.put(ICWaypointAttributes.ATTR_RESOURCE, marker.getResource().getFullPath().toPortableString());
