...
public class AllTests {
	...
	public static Test suite() {
		TestSuite suite = new TestSuite("Test for ca.uvic.cs.tagsea.tests");
		//$JUnit-BEGIN$
		...
		suite.addTestSuite(TagTreeItemListenerTest.class);
		suite.addTestSuite(TagRefactoringTest.class);
