...
public class SelectPerspectiveDialog extends Dialog implements
    ...
    private IPerspectiveDescriptor fSelectedDescriptor;
    ...
    protected void configureShell(Shell shell) {
        ...
        shell.setText("Select perspective to open");
    ...
    protected Control createContents(Composite parent) 
    {
        ...
        if(fSelectedDescriptor != null)
        	list.setSelection(new StructuredSelection(fSelectedDescriptor),true);
    ...
    protected Control createDialogArea(Composite parent) {
        ...
        createEffectsArea(composite);
       
        // Return results.
        return composite;
    }

    private void createEffectsArea(Composite parent) 
    {	
	...
	public void setSelectedDescriptor(IPerspectiveDescriptor descriptor)
	{
