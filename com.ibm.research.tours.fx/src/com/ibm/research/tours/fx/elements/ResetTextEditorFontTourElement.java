...
public class ResetTextEditorFontTourElement extends AbstractTourElement 
{
	public static final String TEXT = "Reset text editor font";
	...
	{
		return new ResetTextEditorFontTourElement();
	}
}
