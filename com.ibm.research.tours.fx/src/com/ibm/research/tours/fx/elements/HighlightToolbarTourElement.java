...
public class HighlightToolbarTourElement extends AbstractTourElement 
{
	public static final String TEXT = "Highlight toolbar";
	...
	public void transition() 
	{
		fJob = new WorkbenchJob("")
		{
			public IStatus runInUIThread(IProgressMonitor monitor) 
			{
				...
				Rectangle bounds = EclipseFx.getUpperAreaBounds(page);
	...
	{
		return new HighlightToolbarTourElement();
	}
}
