...
public class ResetGlobalHighlightTourElement extends AbstractTourElement 
{
	public static final String TEXT = "Reset global highlighting";
	...
	{
		return new ResetGlobalHighlightTourElement();
	}
}
