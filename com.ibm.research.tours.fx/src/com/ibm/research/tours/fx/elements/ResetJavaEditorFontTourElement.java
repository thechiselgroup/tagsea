...
public class ResetJavaEditorFontTourElement extends AbstractTourElement 
{
	public static final String TEXT = "Reset java editor font";
	...
	{
		return new ResetJavaEditorFontTourElement();
	}
}
