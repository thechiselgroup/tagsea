...
/**
 * changes cursor to use big cursor
 * 
 * @author Li-Te Cheng
 * CUE, IBM Research 2006
 */
public class BigCursorTourElement extends AbstractTourElement {

	public ITourElement createClone() {
		return new BigCursorTourElement();
	}

	public Image getImage() {
		return ToursFxPlugin.getDefault().getImageRegistry().get(ToursFxPlugin.IMG_BIG_ICON);
	}
