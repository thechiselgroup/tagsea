...
public class FadeToBlackTourElement extends AbstractTourElement 
{
	public static final String TEXT = "Fade to black";
	...
	{
		return new FadeToBlackTourElement();
	}
}
